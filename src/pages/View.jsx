    ...
    <>
      ...
      <div className="flex flex-col mx-5">
        <div className="grid grid-cols-2 items-center h-screen">
          <div>
            <img width={"450px"} height={"200px"} src={product?.thumbnail} />
            <div className="flex justify-between mt-5">
                  <button onClick={handleWishlist} className="bg-blue-600 text-white p-2">
                    Add to Whishlist
                  </button>
                  <button onClick={handleCart} className="bg-green-600 text-white p-2">
                    Add to Cart
                  </button>
                </div>
          </div>
